...
function createBoard() {
    startPieces.forEach((startPiece, i) => {
        ...
        if (row % 2 === 0) {
            square.classList.add(i % 2 === 0 ? "red" : "grey")
        } else {
            square.classList.add(i % 2 === 0 ? "grey" : "red")
        }
...
// Funktionen für Figurenbewegung 
    ...
    break;
        case 'bishop' :
            if ( 
                ...
                // -- forwards second direction check
                ...
                // -- backwards second direction check
   ...
   break;
        case 'king' :
            if (
                startId + 1 === targetId ||
                startId - 1 === targetId ||
                startId + widht === targetId ||
                startId - widht === targetId ||
                startId + widht - 1 === targetId ||
                startId + widht + 1 === targetId ||
                startId - widht - 1 === targetId ||
                startId - widht + 1 === targetId 
            ) {
...
function changePlayer() {
    ...
    // Ids umdrehen, wenn Spieler wechselt
function reverseIds() {
    const allSquares = document.querySelectorAll(".square")
...
// if king is not there, other player wins
